        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                  ...
                  <div key={article.id} className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    >
                      <div className="flex-1 pr-4">
                        <h4 className="text-lg font-semibold text-gray-900 group-hover:text-[#003C50] transition-colors mb-2">
                          {article.title}
                        </h4>
          ...
          <div className="flex justify-center lg:justify-end relative">
            <div className="relative w-[350px] h-[350px] md:w-[450px] md:h-[450px]">
              ...
              {/* Decorative green circle overlay */}
              <div className="absolute top-10 -right-10 w-32 h-32 bg-[#C8DC00] rounded-full opacity-70"></div>
            </div>
          </div>
        </div>
      </div>
